...
const EVM_RPC_FALLBACKS = {
  ...
  "XDC Network": ["https://rpc.xinfin.network", "https://rpc1.xinfin.network"],
  "MegaETH Mainnet": ["https://mainnet.megaeth.com/rpc"],
  "Metal L2": ["https://rpc.metall2.com"],
  Plasma: ["https://rpc.plasma.to"],
  MemeCore: ["https://rpc.memecore.net"],
  "Shido Network": ["https://shido-mainnet-archive-lb-nw5es9.zeeve.net/USjg7xqUmCZ4wCsqEOOE/rpc"],
  "Etherlink Mainnet": ["https://node.mainnet.etherlink.com"],
  Soneium: ["https://rpc.soneium.org"],
  "X Layer Mainnet": ["https://xlayerrpc.okx.com"],
  ...
  "Ethereum Classic": ["https://etc.rivet.link", "https://besu-at.etc-network.info"],
  "KCC Mainnet": ["https://rpc-mainnet.kcc.network", "https://public-rpc.blockpi.io/http/kcc"],
  Conflux: ["https://evm.confluxrpc.com"],
  "EOS EVM": ["https://api.evm.eosnetwork.com"],
